...
**Current releases:** terminal app 0.3.0 · VS Code extension 0.6.2 · browser companion 0.17.0 (Chrome + Firefox) (see [CHANGELOG.md](CHANGELOG.md)).
...
| `POST` | `/run` | VS Code-only: compile and run supplied code against caller-supplied samples (powers the in-browser editor's Run, with optional execution trace) |
